...
# Remove specified rows from both_counts
both_counts <- both_counts[-rows_to_remove, ]


# Removing empty participants iwth no CDI data T2
# Define the rows to be removed
rows_to_remove <- c(9, 10, 17, 19:25)
...
write.csv(both_counts, 
          file.path('raw-csv', 'Analysis', '9.both_counts.csv'),
          row.names=FALSE)
